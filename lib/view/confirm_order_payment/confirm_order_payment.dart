...
class ConfirmOrderPaymentView extends GetView<ConfirmOrderController> {
  const ConfirmOrderPaymentView({super.key});
            ...
            builder: (controller) {
              return FutureBuilder<OrderDone?>(
                  future: PaymentRepository.getDoneConfirmation(
                      id: PaymentRepository.combineId),
                            ...
                            child: Column(
                              children: [
                                ...
                                _buildInfoRow(
                                    ...
                                    context),
                                _buildInfoRow("${Strings.PAYMENT_METHOD.tr}:",
                                    snapshot.data?.paymentType ?? "", context),
                                _buildInfoRow("${Strings.PAYMENT_STATUS.tr}:",
                                    snapshot.data?.paymentStatus ?? "", context),
                                _buildInfoRow(
