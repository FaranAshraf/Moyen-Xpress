...
class HomeTopBrands extends GetView<HomeController> {
  const HomeTopBrands({super.key});
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: CustomFutureBuilder(
        ...
        future: HomeRepository.getTopBrands(),
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) => PaginatedListViewCardContent(
        ...
        buttonTitle: Strings.VIEW.tr,
              onCardTap: (id) => Get.toNamed(Routes.NEW_ARRIVALS),
        onPrimaryButtonTap: (productId) => Get.toNamed(Routes.NEW_ARRIVALS),
      ),
    );
  }
}
