...
import '../../view_model/controllers/new_arrival/new_arrival_controller.dart';

class NewArrivals extends GetView<NewArrivalController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(Strings.NEW_ARRIVALS.tr),
        centerTitle: true,
        leadingWidth: 50.0,
